...
class ConfigForm(FlaskForm):
    ...
    nom_interest_rt = FloatField(label= ('Nominal Interest Rate:'), validators=[DataRequired(), NumberRange(min=0.0000001, max=0.9999999)])
    inflation_rt = FloatField(label= ('Inflation Rate:'), validators=[DataRequired(), NumberRange(min=0.0000001, max=0.9999999)])
    ...
    reg_conv_cost_p_credit_abv_min_thresh_of_credit = FloatField(label= ('Registry Conversion Cost per Credit above Minimum Threshold of Credits:'), validators=[DataRequired(), NumberRange(min=0.0000001, max=0.9999999)])
    reg_levy_cost_p_credit = FloatField(label= ('Registry Levy Cost per Credit:'), validators=[DataRequired(), NumberRange(min=0.0000001, max=0.9999999)])
    ...
    interest_rate = FloatField(label= ('Interest Rate:'), validators=[DataRequired(), NumberRange(min=0.0000001, max=0.9999999)])
