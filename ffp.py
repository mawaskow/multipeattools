...
def Conditional_Executor(user_list, assum_list):
        ...
        "real_interest_rate": round(real_interest_rate,6),
        "credits_generated": round(credits_generated,2),
        "cost_per_credit": round(cost_per_credit,2),
        "beginning_value": "{:.2f}".format(beginning_value),
        "ending_value_undisc": "{:.2f}".format(float(ending_value_undisc)),
        "carbon_investment_cost_per_payment": "{:.2f}".format(carbon_investment_cost_per_payment),
        "carbon_investment_annual_costs": "{:.2f}".format(carbon_investment_annual_costs,),
        "total_investment_costs": "{:.2f}".format(total_investment_costs),
        "number_of_inspections": number_of_inspections,
        "registry_cost_recurring": "{:.2f}".format(registry_cost_recurring),
        "registry_cost_per_credit": "{:.2f}".format(registry_cost_per_credit),
        "registry_cost_credits_above_threshold": "{:.2f}".format(registry_cost_credits_above_threshold),
        "total_registry_costs": "{:.2f}".format(total_registry_costs),
        "CARG_exponent": round(CARG_exponent,6),
        "total_project_costs_undisc": "{:.2f}".format(total_project_costs_undisc),
        "ending_value_discounted": "{:.2f}".format(float(ending_value_disc)),
        "total_project_costs_disc": "{:.2f}".format(total_project_costs_disc),
        "rate_of_return": round(rate_of_return,2),
        "CARG": round(CARG,2),
        "gross_present_value": f"{round(gross_present_value):,}",
        "net_present_value": f"{round(net_present_value):,}",
